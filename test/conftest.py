...
@pytest.fixture()
def skip_generation_tests(request):
    if request.config.option.skip_generation_tests:
        pytest.skip()


@pytest.fixture()
def skip_resolver_tests(request):
    if request.config.option.skip_resolver_tests:
        pytest.skip()
