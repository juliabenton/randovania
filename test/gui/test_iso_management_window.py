...
def test_create_log_file_pressed(mock_pre_export_checks: MagicMock,
    ...
    skip_qtbot.addWidget(default_iso_window)

    # Run
    skip_qtbot.mouseClick(default_iso_window.randomize_log_only_button, QtCore.Qt.LeftButton)
...
def test_create_log_file_pressed_spoiler_disabled(mock_create_log_file_pressed: MagicMock,
    ...
    # Run
    skip_qtbot.mouseClick(window.randomize_log_only_button, QtCore.Qt.LeftButton)
...
def test_clear_game_button_pressed(mock_delete_files_location: MagicMock,
    ...
    # Run
    skip_qtbot.mouseClick(default_iso_window.clear_game_button, QtCore.Qt.LeftButton)
